...
def create_login_frame(root):
    ...
    login_frame = tk.Frame(root, padx=20, pady=20, bg='#404040')
    login_frame.place(relx=0.5, rely=0.5, anchor='center')

    tk.Label(login_frame, text="────────୨ Selamat Datang ৎ────────", font=("Adobe Garamond Pro Bold", 15, "bold"), bg='#404040', fg='white').grid(row=0, columnspan=2)
...
def create_chat_frame(root):
    ...
    chat_frame = tk.Frame(root, padx=20, pady=20, bg='#404040')
